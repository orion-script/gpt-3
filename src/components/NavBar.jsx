...
const NavBar = () => {
    ...
    return (
        <nav className="flex justify-between w-10/12 m-auto py-10">
            ...
            <div ref={openRef} className="hidden toggleOpen absolute bg-gray-800 w-3/4 h-screen py-10 md:hidden right-0 top-0 font-bold text-xl flex flex-col rounded-l-lg">
                <img src={Close} alt="Menu" className="w-1/12 absolute right-5" onClick={toggleSideBar}/>
                <div className="w-3/4 pl-10 pt-10 flex flex-col">
                    <a href="#home" className="py-5">Home</a>
                    <a href="#whatisgpt" className="py-5">What is GPT?</a>
                    <a href="#openai" className="py-5">Open AI</a>
                    <a href="#casestudie" className="py-5">Case Studies</a>
                    <a href="#library" className="py-5">Library</a>
                </div>
