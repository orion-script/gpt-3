...
const Gallery = () => {
    return (
        <div className="w-10/12 h-auto m-auto flex flex-col md:flex-row justify-between py-10">
            <div className="flex flex-col w-full md:w-4/12 h-auto">
                <img src={Rectangle1} alt={Rectangle1} className="w-full h-40 md:h-72"/>
                <div className="w-full h-48 md:h-96 bg-galleryBack flex flex-col justify-between">
                    <div className="w-full">
                        <p className="px-5 py-4 md:py-5 text-sm">{new Date().toDateString()}</p>
                        <h3 className="px-5 font-bold text-lg md:text-2xl">GPT-3 and Open  AI is the future. Let us exlore how it is?</h3>
                    </div>
            ...
            <div className="flex flex-col w-full md:w-3/12 justify-between">
                <div className="py-10 md:py-0">
                    ...
                    <div className="w-full h-48 bg-galleryBack">
                        <p className="px-5 pt-4 text-sm">{new Date().toDateString()}</p>
                        <h3 className="px-5 font-bold text-lg py-5">GPT-3 and Open  AI is the future. Let us exlore how it is?</h3>
